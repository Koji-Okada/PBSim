...
public final class QLSimulator2 {
     ...
     *
     */
    private static final int PROJECT_SIZE = 160;
    private static final int PROJECT_HR = 4;
    ...
    private void showProjectState(final ProjectState st) {
        ...
        ServiceModel2 sm0 = new ServiceModel2(90.0e0D, 1.0e0D);
        ServiceModel2 sm1 = new ServiceModel2(40.0e0D, 1.0e0D);
