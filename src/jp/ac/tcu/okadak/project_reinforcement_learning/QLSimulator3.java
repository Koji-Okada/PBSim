...
public final class QLSimulator3 {
     ...
     *
     */
    private static final int PROJECT_SIZE = 140;
    private static final int PROJECT_HR = 5;
    ...
    private void showProjectState(final ProjectState st) {
        ...
        ServiceModel3 sm0 = new ServiceModel3(100.0e0D, 1.0e0D);
        ServiceModel3 sm1 = new ServiceModel3(50.0e0D, 1.0e0D);
