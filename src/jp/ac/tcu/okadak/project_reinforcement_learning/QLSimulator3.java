 ...
 */
public final class QLSimulator3 {
...
//	private static final int PROJECT_HR = 20;
	...
	public static void main(final String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			// エージェント10体で実行する
			QLSimulator3 simulator = new QLSimulator3();
	...
	private void showProjectState(final ProjectState st) {
		...
		// System.out.println();
		System.out.printf("compromiseWorks rate = \t%8.3f\t%8.3f",
				scopeChangeRate, 1.0e0D - scopeChangeRate);
		...
		//
		// double bizRes0 = sm0.perform(scheduleDelay, costOverrun,
		// scopeChangeRate);
		// double bizRes1 = sm1.perform(scheduleDelay, costOverrun,
		// scopeChangeRate);
		// double bizRes2 = sm2.perform(scheduleDelay, costOverrun,
		// scopeChangeRate);
		//
